    ...
    <div className="bg-[#5D6C83] mt-20 p-8">
      <div className="relative flex justify-center items-center space-x-96 px-10 mb-10">
        <div className="absolute top-0 left-10 mr-10">
          <h1 className="text-3xl font-semibold text-left text-gray-100 mb-5">
            Weekly Newsletter
          </h1>
          <h1 className="text-sm font-semibold text-left text-gray-200">
            GET THE LATEST NEWS!{" "}
          </h1>
        </div>
        <div className="flex space-x-5">
          ...
          />
          <button className="btn bg-yellow text-white rounded-lg border-none">
            Subscribe
          </button>
        </div>
      </div>
      <footer className="footer p-10 bg-[#5D6C83] text-white">
        <nav>
          ...
          <h5 className="text-md text-gray-300 flex items-center">
            {" "}
            <PhoneIcon className="h-4 w-4 mr-2" />| (+1) 209 897 3212
          </h5>
          <h5 className="text-md text-gray-300 flex items-center">
            <MapPinIcon className="h-4 w-4 mr-2" />| 20 Levy Ave, California 600{" "}
          </h5>
        </nav>
        <nav>
          ...
          <p className="text-md text-gray-300 flex items-center">
            {" "}
            <ChevronRightIcon className="h-4 w-4 mr-2 -mt-4 text-yellow" />{" "}
            Discover the Next Generation of Smart Home Control with HomeWise.ai{" "}
            <br /> 5 Minutes Ago
          </p>
          <p className="text-md text-gray-300 flex items-center">
            {" "}
            <ChevronRightIcon className="h-4 w-4 mr-2 -mt-4 text-yellow" />{" "}
            HomeWise App Tutorials: Managing Users with HomeWise.ai <br /> 5
            Minutes Ago
          </p>
        </nav>
        <nav>
          ...
          <p className="text-yellow mb-5">--------</p>
          <a className="link link-hover text-gray-300 flex items-center">
            <ChevronRightIcon className="h-4 w-4 mr-2 text-yellow" />
            What's New
          </a>
          <a className="link link-hover text-gray-300 flex items-center">
            <ChevronRightIcon className="h-4 w-4 mr-2 text-yellow" />
          ...
          <Link
            to="/contact"
            className="link link-hover text-gray-300 flex items-center"
          >
            <ChevronRightIcon className="h-4 w-4 mr-2 text-yellow" />
            Contact Us
          </Link>
